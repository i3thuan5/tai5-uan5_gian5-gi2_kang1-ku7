...
from 資料佮語料匯入整合.華語台語雙語語料庫系統.對語料庫網站掠資料落來 import 對語料庫網站掠資料落來
...
# 			print(音標.split('\n')[3])
			...
			配對臺語字文章 = '\n'.join(配對臺語字陣列)
			配對臺語音文章 = '\n'.join(配對臺語音陣列)
			國語流水號 = self.加文字佮組合佮版本('華語台語雙語語料庫系統', 章表冊, 國語臺員腔, 臺員, 民國,
				國語, '', 國語文章流水號組合, 版本正常)
			閩南語流水號 = self.加文字佮組合佮版本('華語台語雙語語料庫系統', 章表冊, 閩南語, 臺員, 民國,
				配對臺語字文章, 配對臺語音文章, 閩南語文章流水號組合, 版本正常)
			self.加關係(國語流水號, 閩南語流水號, 義近, '')
			self.加關係(閩南語流水號, 國語流水號, 義近, '')
...
# 			國語集物件 = self.分析器.建立集物件(國語詞)
			try:
				...
				配對臺語字 = 臺語音
			國語流水號 = self.加文字佮版本('華語台語雙語語料庫系統', 字詞, 國語臺員腔, 臺員, 民國,
					國語詞, '', 版本正常)
			閩南語流水號 = self.加文字佮版本('華語台語雙語語料庫系統', 字詞, 閩南語, 臺員, 民國,
				配對臺語字, 臺語音, 版本正常)
# 					閩南語流水號 = 揣文字上大流水號()
			國語關係流水號 = self.加關係(國語流水號, 閩南語流水號, 義近, '')
			閩南語關係流水號 = self.加關係(閩南語流水號, 國語流水號, 義近, '')
		...
		國語流水號 = self.加文字佮組合佮版本('華語台語雙語語料庫系統', 語句, 國語臺員腔, 臺員, 民國,
			一逝國語, '', 國語句流水號組合, 版本正常)
		閩南語流水號 = self.加文字佮組合佮版本('華語台語雙語語料庫系統', 語句, 閩南語, 臺員, 民國,
			一逝配對臺語字, 一逝音標, 閩南語句流水號組合, 版本正常)
		國語句關係流水號 = self.加關係(國語流水號, 閩南語流水號, 義近, '')
		閩南語句關係流水號 = self.加關係(閩南語流水號, 國語流水號, 義近, '')
