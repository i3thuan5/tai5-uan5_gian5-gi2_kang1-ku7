...
感謝您的使用與推廣～～勞力！承蒙！
"""
from 臺灣言語工具.資料佮語料匯入整合.整理中的台語詞典.詞六國語通用拼音轉注音符號表 import 通用佮注音聲韻轉換表
from 臺灣言語工具.資料佮語料匯入整合.整理中的台語詞典.詞六國語通用拼音轉注音符號表 import 通用佮注音調轉換表
...
# 				print(識別碼)
			...
			# 	print(攏總音)
				for 台音 in 攏總音:
					音 = 台音.strip()
					if 音 != '':
						處理過型=self.粗胚工具.數字調英文中央加分字符號(台語漢字)
						處理過音=音.replace('8','6')
