...
from 臺灣言語工具.資料庫.整合.整合入言語 import 揣文字上大流水號
from 臺灣言語工具.資料庫.整合.教育部閩南語常用詞辭典 import 用釋義揣例句
...
from 臺灣言語工具.資料庫.欄位資訊 import 袂當替換
from 臺灣言語工具.資料庫.整合.整合入言語 import 加關係
from 臺灣言語工具.資料庫.整合.教育部閩南語常用詞辭典 import 設定詞性
from 臺灣言語工具.資料庫.整合.整合入言語 import 揣關係上大流水號
from 臺灣言語工具.資料庫.整合.教育部閩南語常用詞辭典 import 詞性對照表
from 臺灣言語工具.資料庫.整合.教育部閩南語常用詞辭典 import 文字無音設定
from 臺灣言語工具.字詞組集句章.解析整理工具.解析錯誤 import 解析錯誤
from 臺灣言語工具.資料庫.整合.教育部閩南語常用詞辭典 import 用流水號揣腔口
from 臺灣言語工具.資料庫.欄位資訊 import 文字組合符號
from 臺灣言語工具.資料庫.欄位資訊 import 會當替換
from 臺灣言語工具.資料庫.整合.整合入言語 import 設定文字組合
from 臺灣言語工具.資料庫.整合.教育部閩南語常用詞辭典 import 主編號揣釋義
...
from 臺灣言語工具.資料庫.整合.教育部閩南語常用詞辭典 import 用流水號揣地區
