...
class 句物件轉合成標籤試驗(unittest.TestCase):
	...
	def test_臺灣閩南語羅馬字拼音(self):
		...
		self.檢驗標仔有對無(標籤,
			...
			'ua-H+ai/調:1<2>2/詞:1!4@5/句:1^4_5/驗:',
			'H-ai+tsh/調:1<2>2/詞:1!4@5/句:1^4_5/驗:',
			'ai-tsh+ua/調:2<2>7/詞:2!3@5/句:2^3_5/驗:',
			'tsh-ua+b/調:2<2>7/詞:2!3@5/句:2^3_5/驗:',
			'ua-b+un/調:2<7>7/詞:3!2@5/句:3^2_5/驗:',
	...
	def test_臺灣客家話拼音(self):
		...
		self.檢驗標仔有對無(標籤,
			...
			't-ien+d/調:x<ˊ>ˋ/詞:0!4@4/句:0^4_4/驗:',
			'ien-d+ang/調:ˊ<ˋ>ˋ/詞:1!3@4/句:1^3_4/驗:',
			'd-ang+l/調:ˊ<ˋ>ˋ/詞:1!3@4/句:1^3_4/驗:',
			'ang-l+ab/調:ˋ<ˋ>ˋ/詞:2!2@4/句:2^2_4/驗:',
