...
class 文章粗胚工具試驗(unittest.TestCase):
	def setUp(self):
		self.粗胚工具 = 文章粗胚工具()
	def tearDown(self):
		pass
	...
	def test_建立物件語句前處理奇怪組合(self):
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1- niu5'), 'sui2 koo1 - niu5')
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1 -niu5'), 'sui2 koo1 - niu5')
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1-- niu5'), 'sui2 koo1 - - niu5')
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1--   niu5'), 'sui2 koo1 - - niu5')
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1--niu5'), 'sui2 koo1-0niu5')
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1 - -niu5'), 'sui2 koo1 - - niu5')
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1 --niu5'), 'sui2 koo1 -0niu5')
		self.assertEqual(self.粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音, 'sui2 koo1  --niu5'), 'sui2 koo1 -0niu5')

	def test_符號邊仔加空白(self):
		self.assertEqual(self.粗胚工具.符號邊仔加空白('腹肚枵'), '腹肚枵')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('腹肚枵,'), '腹肚枵 , ')
		self.assertEqual(self.粗胚工具.符號邊仔加空白(':sui2,koo1,niu5...'), ' : sui2 , koo1 , niu5 . . . ')
		self.assertEqual(self.粗胚工具.符號邊仔加空白(' :sui2,   koo1 ,niu5 .  .  .  '), ' : sui2 , koo1 , niu5 . . . ')
		self.assertEqual(self.粗胚工具.符號邊仔加空白(':sui2,koo1,niu5...'), ' : sui2 , koo1 , niu5 . . . ')
		self.assertEqual(self.粗胚工具.符號邊仔加空白(':sui2,koo1,niu5..a.'), ' : sui2 , koo1 , niu5 . . a . ')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('我有100箍'), '我有100箍')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('這馬時間12:20，'), '這馬時間12 : 20 ， ')

	def test_符號邊仔加空白分字符號問題(self):
		self.assertEqual(self.粗胚工具.符號邊仔加空白('sui2 koo1-niu5'), 'sui2 koo1-niu5')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('sui2 koo1  -  niu5'), 'sui2 koo1 - niu5')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('sui2 koo1-0niu5'), 'sui2 koo1-0niu5')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('sui2 koo1-0niu5'), 'sui2 koo1-0niu5')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('這馬分數12 - 20，'), '這馬分數12 - 20 ， ')
		self.assertEqual(self.粗胚工具.符號邊仔加空白('因為12  - 20= - 8，'), '因為12 - 20 = - 8 ， ')

	def test_符號邊仔加空白分字符號無應該處理著的(self):
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2 koo1- niu5')
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2 koo1 -niu5')
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2 koo1-- niu5')
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2 koo1--   niu5')
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2 koo1--niu5')
		...
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2 koo1 --niu5')
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2 koo1  --niu5')
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, '--niu5')
		self.assertRaises(解析錯誤, self.粗胚工具.符號邊仔加空白, 'sui2--')
		
	def test_建立物件語句前減號當作標點符號(self):
		原來語句 = '阮hak8-hau7佇大學路'
		處理好語句 = '阮hak8 - hau7佇大學路'
		加空白後語句 = '阮hak8 - hau7佇大學路'
		self.assertEqual(self.粗胚工具.建立物件語句前減號變標點符號(原來語句), 處理好語句)
		self.assertEqual(self.粗胚工具.符號邊仔加空白(處理好語句), 加空白後語句)
	...
	def test_數字調英文中央加分字符號(self):
		...
		self.assertEqual(self.粗胚工具.數字調英文中央加分字符號(原語句), 結果語句)

if __name__ == '__main__':
	unittest.main()
# 	粗胚工具 = 文章粗胚工具(臺灣閩南語羅馬字拼音)
# 	print(粗胚工具.建立物件語句前處理減號(臺灣閩南語羅馬字拼音,'sui2 koo1- niu5'))
