...
class 辭典連詞斷詞試驗(TestCase):
	...
	def 加我的鞋仔的資料(self):
		...
		我_e5_e5_仔=self.分析器.建立句物件('我 e5 e5 仔')
		鞋集 = 集()
		鞋集.內底組 = [鞋, ]
		的集 = 集()
		的集.內底組 = [的, ]
		...
		我的鞋仔.內底集 = [我, 的集, 鞋集, 仔]
	def 試斷我的鞋仔(self,答案):
		鞋的結果, 鞋的分數 , 鞋的詞數 = self.斷詞.斷詞(self.連詞, 我_e5_e5_仔_鞋的)
		的鞋結果, 的鞋分數, 的鞋詞數 = self.斷詞.斷詞(self.連詞, 我_e5_e5_仔_的鞋)
		e5_e5_結果, e5_e5_分數, e5_e5_詞數 = self.斷詞.斷詞(self.連詞, 我_e5_e5_仔)
		我_e5_e5_仔
		self.assertEqual(答案, 鞋的結果)
		self.assertEqual(答案, 的鞋結果)
		self.assertEqual(答案, e5_e5_結果)
		self.assertLess(0.0, 鞋的分數)
		self.assertEqual(0.0, 的鞋分數)
		self.assertEqual(0.0, e5_e5_分數)
		self.assertEqual(6, 鞋的詞數)
		self.assertEqual(6, 的鞋詞數)
		self.assertEqual(6, e5_e5_詞數)
