...
for 臺羅, 方音 in 臺灣閩南語羅馬字拼音對照吳守禮方音韻母表.items():
    for 方音 in [方音, 方音.replace('ㆪ', 'ㆳ')]:
        for 方音 in [方音, 方音.replace('ㆶ', 'ㆻ')]:  # Unicode 13.0
...
class 方音符號吳守禮改良式:
    ...
    def __init__(self, 注音符號):
        第八調 = False
        if '㆐' in 注音符號 or 'ㆷ̇'[1] in 注音符號:  # 國臺對照活用辭典 ㆴ̇、ㆵ̇、ㆻ̇、ㆷ̇
            第八調 = True
            無第八調注音符號 = 注音符號.replace('㆐', '').replace('ㆷ̇'[1], '')
        else:
            無第八調注音符號 = 注音符號
