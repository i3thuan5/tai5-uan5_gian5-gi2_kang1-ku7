...
class 官方連線工具:
	...
	def 斷詞(self, 語句, 編碼 = 'UTF-8', 等待 = 3, 主機 = '140.109.19.104', 連接埠 = 1501, 帳號 = 'ihcaoe', 密碼 = 'aip1614'):
		return self.連線(語句, 編碼, 等待, 主機, 連接埠, 帳號, 密碼)
	def 剖析(self, 語句, 編碼 = 'Big5', 等待 = 10, 主機 = '140.109.19.112', 連接埠 = 8000, 帳號 = 'ihcaoe', 密碼 = 'aip1614'):
		return self.連線(語句, 編碼, 等待, 主機, 連接埠, 帳號, 密碼)
	def 連線(self, 語句, 編碼 = 'Big5', 等待 = 10, 主機 = '140.109.19.112', 連接埠 = 8000, 帳號 = 'ihcaoe', 密碼 = 'aip1614'):
		連線 = socket(
			AF_INET, SOCK_STREAM)
		連線.settimeout(等待)
		try:
