...
class HTK辨識模型(程式腳本):
    ...
    def _對齊(self, 參數檔, 對照檔,
            標仔檔, 特徵檔, 結果夾, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
    ...
    def 對齊聲韻(self, 聲韻檔, 特徵檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
    ...
    def 對齊音節(self, 音節檔, 特徵檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
        makedirs(資料目錄, exist_ok=True)
        參數檔 = join(資料目錄, '參數檔.cfg')
        self._設定指定參數檔(參數檔)
    ...
    def _辨識(self, 設定檔, 對照檔, 網路檔, 幾條網路, 特徵檔, 結果檔, 結果網路資料夾, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
        if int(幾條網路) > 0:
    ...
    def 辨識聲韻(self, 特徵檔, 資料目錄, 幾條網路, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
        makedirs(資料目錄, exist_ok=True)
        參數檔 = join(資料目錄, '參數檔.cfg')
        self._設定指定參數檔(參數檔)
    ...
    def 辨識音節(self, 特徵檔, 資料目錄, 幾條網路, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
        makedirs(資料目錄, exist_ok=True)
        參數檔 = join(資料目錄, '參數檔.cfg')
        self._設定指定參數檔(參數檔)
