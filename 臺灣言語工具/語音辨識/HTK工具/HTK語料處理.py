...
class HTK語料處理(程式腳本):
    ...
    @classmethod
    def 產生特徵檔(cls, 音檔所在, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.htk執行檔目錄()):
        if isfile(音檔所在):
    ...
    @classmethod
    def 產生特徵佮音節檔(cls, 音檔目錄, 標仔目錄, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.htk執行檔目錄()):
    ...
    @classmethod
    def 產生特徵佮聲韻檔(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.htk執行檔目錄()):
        全部特徵檔, _音節檔, 聲韻檔 = cls.產生特徵佮音節佮聲韻檔(音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑)
        return 全部特徵檔, 聲韻檔

    @classmethod
    def 產生特徵佮音節佮聲韻檔(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.htk執行檔目錄()):
