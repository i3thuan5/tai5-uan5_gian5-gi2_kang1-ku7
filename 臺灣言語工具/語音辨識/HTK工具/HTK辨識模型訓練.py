...
class HTK辨識模型訓練(HTK語料處理):
    ...
    @classmethod
    def 訓練原本標音辨識模型(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
    ...
    @classmethod
    def 訓練拄好短恬辨識模型(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
    ...
    @classmethod
    def 訓練三連音辨識模型(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
    ...
    @classmethod
    def 快速對齊聲韻(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
        (全部特徵檔, _全部標仔檔), (_原來音類檔, _原來音節檔, 原來聲韻類檔, 原來聲韻檔), 做好的初步模型檔 = cls._收集語料而且訓練原始音標初步模型(
            音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑
        )
        快速辨識模型 = HTK辨識模型(
    ...
    @classmethod
    def 對齊聲韻閣加短恬(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
    ...
    @classmethod
    def 對齊音節閣加短恬(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
    ...
    @classmethod
    def _訓練拄好短恬辨識模型閣回傳過程(cls, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=安裝HTK語音辨識程式.執行檔目錄()):
        (全部特徵檔, 全部標仔檔), (原來音類檔, 原來音節檔, 原來聲韻類檔, _原來聲韻檔), 做好的初步模型檔 = cls._收集語料而且訓練原始音標初步模型(
            音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑)
