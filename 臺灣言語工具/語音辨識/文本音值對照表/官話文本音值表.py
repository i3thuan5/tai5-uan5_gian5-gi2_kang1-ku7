...
class 官話文本音值表:
	_文本音值對照表 = 生文本音值對照表()
	def 聲韻對照(self):
		return self._文本音值對照表.生聲韻對照(官話注音符號, 官話注音符號聲, 官話注音符號韻)

	def 聲韻表(self):
		音值韻母表 = 官話注音符號對照音值韻母表.copy()
		音值韻母表['sï'] = 'ɿ'
		音值韻母表['ʂï'] = 'ʅ'
		音值韻母表['tuŋ'] = 'oŋ'
		return self._文本音值對照表.生聲韻表(官話注音符號對照音值聲母表, 音值韻母表)

if __name__ == '__main__':
	文本音值表 = 官話文本音值表()
	print('\n'.join(文本音值表.聲韻對照()), file=open('官話聲韻對照.dict', 'w'))
