...
class 模型訓練(語料處理):
    ...
    def 訓練原本標音辨識模型(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
                   ):
        (全部特徵檔, _全部標仔檔), (原始目錄, _原來音類檔, _原來音節檔, 原來聲韻類檔, 原來聲韻檔), 做好的初步模型檔 = self._收集語料而且訓練原始音標初步模型(
    ...
    def 訓練拄好短恬辨識模型(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
                   ):
        _新拄好短恬聲韻檔, _全部特徵檔, 加短恬辨識模型 = self._訓練拄好短恬辨識模型閣回傳過程(
            音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑
        )
        return 加短恬辨識模型

    def 訓練三連音辨識模型(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
                  ):
        (全部特徵檔, 全部標仔檔), (_原始目錄, 原來音類檔, 原來音節檔, 原來聲韻類檔, _原來聲韻檔), 做好的初步模型檔 = self._收集語料而且訓練原始音標初步模型(
            音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑)

        _短恬目錄, 拄好短恬的重估模型, 加恬聲韻類檔, 新拄好短恬聲韻檔 = self._加短恬而且共時間傷短的短恬提掉(
            執行檔路徑, 資料目錄, 全部特徵檔, 全部標仔檔, 音節聲韻對照檔, 原來音類檔, 原來音節檔, 原來聲韻類檔, 做好的初步模型檔)

        三連音全部縛做伙模型, 三連音全部縛做伙聲韻類檔 = self._三連音重估縛做伙加混合佮加無看過的音(
    ...
    def 加短恬閣對齊(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
               ):
        新拄好短恬聲韻檔, 全部特徵檔, 加短恬辨識模型 = self._訓練拄好短恬辨識模型閣回傳過程(
            音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑
        )
        對齊結果資料夾 = self._細項目錄(資料目錄, '對齊結果')
        return 加短恬辨識模型.對齊聲韻(新拄好短恬聲韻檔, 全部特徵檔, 對齊結果資料夾)

    def _訓練拄好短恬辨識模型閣回傳過程(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
                         ):
        (全部特徵檔, 全部標仔檔), (_原始目錄, 原來音類檔, 原來音節檔, 原來聲韻類檔, _原來聲韻檔), 做好的初步模型檔 = self._收集語料而且訓練原始音標初步模型(
            音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑)

        短恬目錄, 拄好短恬的重估模型, 加恬聲韻類檔, 新拄好短恬聲韻檔 = self._加短恬而且共時間傷短的短恬提掉(
            執行檔路徑, 資料目錄, 全部特徵檔, 全部標仔檔, 音節聲韻對照檔, 原來音類檔, 原來音節檔, 原來聲韻類檔, 做好的初步模型檔)
...
#         上尾聲韻檔 = 新拄好短恬聲韻檔
    ...
    def _三連音重估縛做伙加混合佮加無看過的音(self, 執行檔路徑, 資料目錄,
                            全部特徵檔, 音節聲韻對照檔,
                            新拄好短恬聲韻檔, 加恬聲韻類檔,
                            拄好短恬的重估模型,
                            ):
...
'''
    ...
    def 改模型指令(self, 執行檔路徑, 頂一个模型, 下一个模型, 設定檔, 聲韻類檔):
        return [
            join(執行檔路徑, 'HHEd'), '-A',
