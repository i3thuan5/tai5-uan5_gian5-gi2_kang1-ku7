...
class 模型訓練(語料處理):
    ...
    def 訓練原本標音模型(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
                 ):
    ...
    def 訓練拄好短恬模型(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
                 ):
        ...
        return 短恬加混合模型, 加恬聲韻類檔

    def 訓練三連音模型(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
                ):
        (全部特徵檔, 全部標仔檔), (_原始目錄, 原來音類檔, 原來音節檔, 原來聲韻類檔, _原來聲韻檔), 做好的初步模型檔 = self._收集語料而且訓練原始音標初步模型(
            音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑)
    ...
    def 加短恬閣對齊(self, 音檔目錄, 標仔目錄, 音節聲韻對照檔, 資料目錄, 執行檔路徑=外部程式.htk預設目錄(),
        ...
        模型 = 辨識模型()
        return 模型.對齊聲韻(加恬聲韻類檔, 短恬加混合模型, 新拄好短恬聲韻檔, 全部特徵檔, 對齊結果資料夾)
