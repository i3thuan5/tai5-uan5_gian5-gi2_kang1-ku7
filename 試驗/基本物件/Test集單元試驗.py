...
class 集單元試驗(TestCase):
    ...
    def test_有無音字(self):
        集物件 = 集([拆文分析器.對齊組物件('點仔膠', 'tiam2-a2-ka1'),
                 拆文分析器.建立組物件('，'),
                 拆文分析器.對齊組物件('黏著跤', 'liam5-tioh8 kha1'),
                 拆文分析器.建立組物件('，'),
                 ])
        綜合標音 = 集物件.綜合標音(閩南語字綜合標音)
    ...
    def test_孤字轉json格式(self):
        白組物件 = 拆文分析器.對齊組物件('一', 'tsit8')
        文組物件 = 拆文分析器.對齊組物件('一', 'it4')
        集物件 = 集([白組物件, 文組物件])
    ...
    def test_文白一詞轉json格式(self):
        白組物件 = 拆文分析器.對齊組物件('大人', 'tua7-lang5')
        文組物件 = 拆文分析器.對齊組物件('大人', 'tai7-jin5')
        集物件 = 集([白組物件, 文組物件])
        self.assertEqual(集物件.綜合標音(閩南語字綜合標音), [
            {"詞組綜合標音": [
