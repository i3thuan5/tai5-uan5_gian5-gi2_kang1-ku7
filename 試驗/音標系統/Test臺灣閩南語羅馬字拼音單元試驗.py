...
from 臺灣言語工具.音標系統.閩南語.臺灣閩南語羅馬字拼音 import (臺灣閩南語羅馬字拼音, 臺灣閩南語羅馬字拼音聲母表,
                                        臺灣閩南語羅馬字拼音韻母表, 臺羅對通用聲對照表, 臺羅對通用韻對照表)
from 臺灣言語工具.音標系統.閩南語.通用拼音音標 import 通用拼音佮臺灣羅馬聲母對照表, 通用拼音佮臺灣羅馬韻母對照表
