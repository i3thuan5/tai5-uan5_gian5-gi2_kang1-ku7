...
class 集內組照排單元試驗(TestCase):
    ...
    def test_型照排(self):
        ...
        self.assertEqual(
            self.組照排.排好(排法, 句物件).內底集[0].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        self.assertEqual(self.組照排.排好(排法, 句物件).內底集[1].內底組[0].屬性, 空.屬性)
        self.assertEqual(
            self.組照排.排好(排法, 句物件).內底集[1].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        self.assertEqual(self.組照排.排好(排法, 句物件).內底集[2].內底組[0].屬性, 空.屬性)
        self.assertEqual(
            self.組照排.排好(排法, 句物件).內底集[2].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        章物件 = 章()
        章物件.內底句 = [句物件, 句物件]
        ...
        self.assertEqual(
            self.組照排.排好(排法, 章物件).內底句[0].內底集[0].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        self.assertEqual(self.組照排.排好(排法, 章物件).內底句[0].內底集[1].內底組[0].屬性, 空.屬性)
        self.assertEqual(
            self.組照排.排好(排法, 章物件).內底句[0].內底集[1].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        self.assertEqual(self.組照排.排好(排法, 章物件).內底句[0].內底集[2].內底組[0].屬性, 空.屬性)
        self.assertEqual(
            self.組照排.排好(排法, 章物件).內底句[0].內底集[2].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        self.assertEqual(self.組照排.排好(排法, 章物件).內底句[1].內底集[0].內底組[0].屬性, 空.屬性)
        self.assertEqual(
            self.組照排.排好(排法, 章物件).內底句[1].內底集[0].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        self.assertEqual(self.組照排.排好(排法, 章物件).內底句[1].內底集[1].內底組[0].屬性, 空.屬性)
        self.assertEqual(
            self.組照排.排好(排法, 章物件).內底句[1].內底集[1].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
        self.assertEqual(self.組照排.排好(排法, 章物件).內底句[1].內底集[2].內底組[0].屬性, 空.屬性)
        self.assertEqual(
            self.組照排.排好(排法, 章物件).內底句[1].內底集[2].內底組[1].內底詞[0].屬性, 一.內底詞[0].屬性)
