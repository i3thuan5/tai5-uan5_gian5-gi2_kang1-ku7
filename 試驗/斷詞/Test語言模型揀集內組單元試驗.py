...
class 語言模型揀集內組單元試驗(TestCase):
    ...
    def test_看機率選詞(self):
        ...
        self.語言模型.看(
            拆文分析器.產生對齊句('我鞋仔歹去矣。', 'gua2 e5 a2 phainn2-0khi3 0ah4.'))
        ...
        頂擺分數 = 鞋的分數
        self.語言模型.看(
            拆文分析器.產生對齊句('我的冊佇你遐。', 'gua2 e5 tsheh4 ti7 li2 hia1.')
        )
        self.語言模型.看(
    ...
    def test_標了的型態愛佮原本仝款(self):
        字物件 = 拆文分析器.產生對齊字('媠', 'sui2')
        詞物件 = 拆文分析器.產生對齊詞('姑娘', 'koo1-niu5')
        組物件 = 拆文分析器.產生對齊組('媠姑娘', 'sui2 koo1-niu5')
        集物件 = 拆文分析器.產生對齊集('媠姑娘', 'sui2 koo1-niu5')
        句物件 = 拆文分析器.產生對齊句('我佮意媠姑娘', 'gua2 kah4 i3 sui2 koo1-niu5')
        章物件 = 拆文分析器.產生對齊章(
    ...
    def test_選無仝長度的集(self):
        self.語言模型 = 實際語言模型(3)
        媠姑娘 = 拆文分析器.產生對齊組('媠姑娘', 'sui2 koo1-niu5')
        靚細妹 = 拆文分析器.產生對齊組('靚細妹', 'jiangˊ-se-moi')
        大美女 = 拆文分析器.產生對齊組('世界大大美女', 'se3-kai3 tua7 tua7 mi2-lu2')
        莉 = 集([媠姑娘, 靚細妹, 大美女])
        我 = 拆文分析器.產生對齊集('我', 'gua2')
        愛 = 拆文分析器.產生對齊集('愛', 'ai3')
        呀 = 拆文分析器.產生對齊集('！', '!')
