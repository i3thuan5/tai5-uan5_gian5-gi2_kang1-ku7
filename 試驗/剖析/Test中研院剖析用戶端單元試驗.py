...
class 中研院剖析用戶端單元試驗(unittest.TestCase):
    ...
    def test_結構剖一逝字(self, 語句剖析做語句mock):
        ...
        self.assertEqual(self.用戶端.語句剖析後結構化('我想吃飯。我想吃很多飯。'), [[
            ('1', ['S', ['NP', ('我', 'N', 'Head')], ('想', 'Vt', 'Head'),
                   ['VP', ('吃飯', 'Vi', 'Head')]], '。(PERIODCATEGORY)'),
            ('2', ['S', ['NP', ('我', 'N', 'Head')], ('想', 'Vt', 'Head'), [
             'VP', ('吃', 'Vt', 'Head'), ['NP', ('很多', 'DET'), ('飯', 'N', 'Head')]]], '。(PERIODCATEGORY)'),
        ],
        ])
