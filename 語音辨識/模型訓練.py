...
# 		if 做初步模型:
		...
		if 加切短恬:
			...
			_辨識模型=辨識模型()
			對齊聲韻結果檔 = _辨識模型.對齊聲韻(加恬聲韻類檔, 加短恬的重估模型, 加恬聲韻檔,
		...
		if 三連音:
			...
			self.音標換三連音(執行檔路徑, 三連音目錄, 上尾聲韻檔, 三連音聲韻類檔, 三連音聲韻檔)
			三連音模型檔 = os.path.join(三連音目錄, '三連音模型檔.macro')
			self.模型換三連音(執行檔路徑, 三連音目錄, 上尾模型檔, 上尾聲韻類檔, 三連音模型檔, 三連音聲韻類檔)
			...
			三連音縛做伙聲韻類檔 = os.path.join(三連音目錄, '三連音縛做伙聲韻類檔.list')
