...
# 		if 做初步模型:
		...
		做好的初步模型檔 = self.模型重估(執行檔路徑, 資料目錄, 全部特徵檔, 聲韻類檔, 聲韻檔, 初步模型檔, 估幾擺=60)
		上尾模型檔 = 做好的初步模型檔
		上尾聲韻類檔 = 聲韻類檔
		上尾聲韻檔 = 聲韻檔
		if 加切短恬:
			...
			加短恬縛好模型 = os.path.join(資料目錄, '加短恬縛好模型.macro')
			self.恬音佮短恬愛縛做伙(執行檔路徑, 資料目錄, 加短恬的模型, 加短恬縛好模型, 加恬聲韻類檔)
			加短恬的重估模型 = self.模型重估(執行檔路徑, 資料目錄, 全部特徵檔,
				加恬聲韻類檔, 加恬聲韻檔, 加短恬縛好模型, 估幾擺=20)
			
			對齊聲韻結果檔 = self.對齊聲韻(加恬聲韻類檔, 加短恬的重估模型, 加恬聲韻檔,
			...
			上尾聲韻檔 = 新拄好短恬聲韻檔
		if 三連音:
			三連音聲韻類檔 = os.path.join(資料目錄, '三連音聲韻類檔.list')
			三連音聲韻檔 = os.path.join(資料目錄, '三連音聲韻檔.mlf')
			self.音標換三連音(執行檔路徑, 資料目錄, 上尾聲韻檔, 三連音聲韻類檔, 三連音聲韻檔)
			三連音模型檔 = os.path.join(資料目錄, '三連音模型檔.macro')
			self.模型換三連音(執行檔路徑, 資料目錄, 上尾模型檔, 上尾聲韻類檔, 三連音模型檔, 三連音聲韻類檔)
			三連音重估模型 = self.模型重估(執行檔路徑, 資料目錄, 全部特徵檔,
				三連音聲韻類檔, 三連音聲韻檔, 三連音模型檔, 估幾擺=20)
			三連音統計檔 = 三連音重估模型[:-len('.macro')] + '.sts'
			三連音縛做伙模型 = os.path.join(資料目錄, '三連音縛做伙模型.macro')
			三連音縛做伙聲韻類檔 = os.path.join(資料目錄, '三連音縛做伙聲韻類檔.list')
			三連音縛做伙樹檔 = os.path.join(資料目錄, '三連音縛做伙樹檔.tree')
			self.模型相倚三連音縛做伙(執行檔路徑, 資料目錄,
				三連音模型檔, 三連音聲韻類檔, 三連音統計檔, 上尾聲韻類檔,
