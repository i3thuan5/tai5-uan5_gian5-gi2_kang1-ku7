...
揣主條目 = 資料庫連線.prepare('SELECT "主編號","屬性","詞目","音讀","方言差" ' +
    'FROM "教育部臺灣閩南語常用詞辭典"."詞目總檔" WHERE "主編號"=\'66\' ORDER BY "主編號" ASC')
...
揣釋義 = 資料庫連線.prepare('SELECT "流水號","主編號","詞性","釋義" ' +
    'FROM "教育部臺灣閩南語常用詞辭典"."釋義" ORDER BY "流水號" ASC LIMIT 5')

用釋義揣例句 = 資料庫連線.prepare('SELECT "例句","標音","例句翻譯" ' +
    'FROM "教育部臺灣閩南語常用詞辭典"."例句" WHERE "釋義編號"=$1 ORDER BY "流水號"')
