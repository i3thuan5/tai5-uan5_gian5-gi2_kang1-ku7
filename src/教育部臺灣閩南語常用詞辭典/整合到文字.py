...
for 主編號, 屬性, 文字, 音標, 方言差 in 揣主條目():
    ...
    主音 -= 音空
    for 音 in 主音:
        if 文字 not in 腔口集['偏漳優勢音']:
            腔口集['偏漳優勢音'][文字] = []
        if 文字 not in 腔口集['偏泉優勢音']:
            腔口集['偏泉優勢音'][文字] = []
        雙優勢音 = 音.split('/')
        if 音 == 'Jû/Lû/Jî':
            腔口集['偏漳優勢音'][文字].append(雙優勢音[2])
            腔口集['偏泉優勢音'][文字].append(雙優勢音[0])
            腔口集['偏泉優勢音'][文字].append(雙優勢音[1])
            continue
        if len(雙優勢音) == 1:
            雙優勢音.append(雙優勢音[0])
#        print(雙優勢音)
...
#        print(文字)
        腔口集['偏漳優勢音'][文字].append(偏漳優勢音)
        腔口集['偏泉優勢音'][文字].append(偏泉優勢音)
