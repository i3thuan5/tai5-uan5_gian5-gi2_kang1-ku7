...
class 整合到文字():
	def __init__(self):
		...
		# 13602因
		音空 = {''}
		for 主編號, 屬性, 文字, 音標, 方言差 in 揣主條目(6032):
			print(主編號)
			if 屬性 == 25:
				種類 = '語句'
			else:
			...
			for 腔口, 字音 in 腔口集.items():
				for 字, 音集 in 字音.items():
					...
					for 音 in 音集:
						...
						if 資料字型體 =="大目新娘無看見灶 。":
								資料字型體 = "大目新娘無看見灶"
								音 = "Tuā ba̍k sin-niû bô khuànn-kìnn tsàu ."
						if 資料字型體 == "手曲 ， 屈入無屈出 。":
								資料字型體 = "手曲屈入無屈出"
								音 =	"Tshiú-khiau khut-ji̍p bô khut-tshut"
						if 資料字型體 =="收瀾收予焦 ， 予你生一个有":
								資料字型體 = "收瀾收予焦予你生一个有"
								音 =	"Siu-nuā siu hōo ta hōo lí senn tsi̍t ê ū lān-pha"				
						if 資料字型體 =="盡人事 ， 順天意 。":
								資料字型體 = "盡人事順天意 。"
								音 =	"Tsīn jîn-sū sūn thinn-ì"
						# m7 tioh8
