...
from 字詞集句章.音標系統.閩南語.通用拼音佮臺灣語言音標調類對照表 import 臺羅對通用聲韻對照表
from 字詞集句章.音標系統.閩南語.通用拼音佮臺灣語言音標調類對照表 import 臺羅對通用調對照表
from 字詞集句章.音標系統.閩南語.臺灣閩南語羅馬字拼音轉方音符號吳守禮改良式模組 import 臺灣閩南語羅馬字拼音轉方音符號吳守禮改良式模組
